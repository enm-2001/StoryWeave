    ...
    <div class="wrapper">
      ...
      <form class="form__contact" @submit.prevent="postStory">
        <fieldset>
          ...
          <p>
            Story starts like this -><textarea
              rows="4"
              cols="40"
...
.</textarea
          ...
          <span v-if="titleNotExist" style="color: red"
            >Please enter the details of your story..</span
          >
          <button
            type="submit"
            v-if="displaySubmit"
            class="button button--xlarge"
            tabindex="4"
          >
            Submit! &#187;
          </button>
          ...
          <label
            ...
            >Post it <i class="uil uil-expand-arrows"></i
          ></label>
          <div class="modal">
