        ...
        <form class="form__contact" @submit.prevent="postStory">
            <fieldset>
                <p>
                    ...
                    <textarea cols="40" class="form__field field--name" placeholder="storytitle" tabindex="1" v-model="story.title" readonly></textarea>
                </p>
                <p>
                    Story starts like this -><textarea rows="4" cols="40" class="form__field field--story" placeholder="story" tabindex="3" v-model="story.description" readonly>
.</textarea>
                </p>
                <p>
                    Continue the story -><textarea rows="4" cols="40" class="form__field field--story" placeholder="story" tabindex="3" v-model="des">
.</textarea>
                </p>
                <span v-if="titleNotExist" style="color: red">Please enter the details of your story..</span>
                <button type="submit" v-if="displaySubmit" class="button button--xlarge" tabindex="4">
                    Submit! &#187;
                </button>
                ...
                <div class="modal">
                    <div class="modal-wrap">
                        ...
                        <button type="button" @click="completedButton(story, 1)" style="padding-right: 50px">
                            Yes
                        </button>
                        <button type="button" @click="completedButton(story, 0)" style="padding-right: 50px">
                            No
                        </button>
                    </div>
                </div>
...
.form__contact {
    ...
    fieldset {
        ...
        background: #fff linear-gradient(rgba(0, 0, 0, 0.1) 1px, transparent 0) 0 20px / 100% $line-height;
