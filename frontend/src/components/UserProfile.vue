        ...
        <div class="card-row" style="padding-bottom: 0px">
            ...
            <div class="card">
                <div class="content-row">
                    ...
                    <p class="card-description">
                        <i class="fas fa-coins" style="font-size: 35px"></i>
                    </p>
                </div>
                <div class="card-data">
                    <p>{{ details.coins }}</p>
            ...
            <div class="card">
                <div class="content-row">
                    ...
                    <p class="card-description">
                        <i class="fas fa-pen" style="font-size: 35px"></i>
                    </p>
                </div>
                <div class="card-data">
            ...
            <div class="card">
                <div class="content-row">
                    ...
                    <p class="card-description">
                        <i class="fa-sharp fa-solid fa-pen-fancy" style="font-size: 35px"></i>
                    </p>
                </div>
                <div class="card-data">
    ...
    async mounted() {
        ...
        try {
            ...
            const res2 = await axios.get(
                `http://localhost:5000/api/users/startedstories/${user_id}`
            );
            this.startedStories = res2.data;
            //   console.log("Started stories: ",this.startedStories);
            const res3 = await axios.get(
                `http://localhost:5000/api/users/contributedstories/${user_id}`
            );
